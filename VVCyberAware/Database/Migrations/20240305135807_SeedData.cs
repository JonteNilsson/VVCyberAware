    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Info om bedrägeri", "Bedrägeri" });

            migrationBuilder.InsertData(
                table: "Segments",
                columns: new[] { "Id", "CategoryId", "Name", "UserId" },
                values: new object[] { 1, 1, "Del 1", "[]" });

            migrationBuilder.InsertData(
                table: "SubCategories",
                columns: new[] { "Id", "Description", "SegmentId" },
                values: new object[] { 1, "Something", 1 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "Explanation", "QuestionText", "SubCategoryId" },
                values: new object[] { 1, null, "Vad är din favorit färg?", 1 });
